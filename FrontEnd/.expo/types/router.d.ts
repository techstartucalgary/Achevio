...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(Login)/..swp` | `/..swp` | `/(Login)/Landing` | `/Landing` | `/(Login)/_layout` | `/_layout` | `/(Login)/home` | `/home` | `/(Login)/` | `/(Login)` | `/(Login)/login` | `/login` | `/(Login)/signup` | `/signup` | `/(Settings)/AboutUs` | `/AboutUs` | `/(Settings)/AddPaymentMethod` | `/AddPaymentMethod` | `/(Settings)/ChangePassword` | `/ChangePassword` | `/(Settings)/EditProfile` | `/EditProfile` | `/(Settings)/InviteFriends` | `/InviteFriends` | `/(Settings)/PrivacyPolicy` | `/PrivacyPolicy` | `/(Settings)/SecurityAndPrivacy` | `/SecurityAndPrivacy` | `/(Settings)/_layout` | `/(pages)/CommunitiesPage` | `/CommunitiesPage` | `/(pages)/EditPost` | `/EditPost` | `/(pages)/Photopreview` | `/Photopreview` | `/(pages)/PickCommunity` | `/PickCommunity` | `/(pages)/Videopreview` | `/Videopreview` | `/(pages)/_layout` | `/(tabs)/Camera` | `/Camera` | `/(tabs)/Collage` | `/Collage` | `/(tabs)/Communities` | `/Communities` | `/(tabs)/Profile` | `/Profile` | `/(tabs)/Search` | `/Search` | `/(tabs)/_layout` | `/+html` | `/modal` | `/redux/actions` | `/redux/reducers` | `/redux/store`;
  // prettier-ignore
