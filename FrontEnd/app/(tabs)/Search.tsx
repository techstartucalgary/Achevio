...
import { StyleSheet, View, TextInput, Text, TouchableOpacity, ScrollView, SafeAreaView, StatusBar } from 'react-native';
...
const Tag: React.FC<TagProps> = ({ text, selected, onSelect }) => (
  <TouchableOpacity style={[styles.tag, selected && styles.tagSelected]} onPress={onSelect}>
...
const RadioButton: React.FC<RadioButtonProps> = ({ label, value, onPress, selectedValue }) => (
...
const Search: React.FC = () => {
  ...
  const tags = ['Creativity', 'Creepy', 'Cramming', 'Craft', 'Car', 'Colour', 'Celebrate', 'Cat', 'Cookie'];
    ...
    <SafeAreaView style={styles.container}>
      ...
      {isFiltersVisible && (
        <ScrollView style={styles.scrollView}>
          ...
          {['Community name', 'Community tags', 'Communities my friends are in'].map(option => (
            <RadioButton
              key={option}
              label={option}
              value={option}
